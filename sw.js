...
// প্রতিবার অ্যাপের কোনো ফাইল (HTML, CSS, JS) আপডেট করার পর এই নামটি পরিবর্তন করুন (যেমন: v7, v8)।
const CACHE_NAME = 'talika-cache-v1'; // একটি নতুন নাম দিয়ে শুরু করুন

// ধাপ ২: যে ফাইলগুলো অফলাইনে ব্যবহারের জন্য একেবারে শুরুতে ক্যাশ করতে চান।
// আপনার নতুন manifest.json ফাইলের সকল আইকন এখানে যোগ করা হয়েছে।
const URLS_TO_CACHE = [
  '/', // অ্যাপের মূল পাতা (index.html)
  'https://cdn.jsdelivr.net/gh/ImrulKayess/talika-app/manifest.json',

  // নতুন manifest.json অনুযায়ী সকল প্রয়োজনীয় আইকন
